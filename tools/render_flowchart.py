...
BORDER_SEQUENCE = (87, 242, 135)   # green — sequence digest
BORDER_SESSION = (155, 89, 182)     # purple — session digest
BORDER_PACK = (52, 152, 219)        # blue — AF night pack export
...
def main():
    ...
    draw.text((88, 38), "v0.1.0.1+", fill=SUB, font=font(12, bold=True))
    ...
    # Per-run chain — color steps toward destination post
    chain_y = 360
