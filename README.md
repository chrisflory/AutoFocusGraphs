...
> **Latest release:** [v0.1.0.5](https://github.com/chrisflory/AutoFocusGraphs/releases/tag/v0.1.0.5) — multi-destination autofocus graph delivery for N.I.N.A. 3.3 nightlies.
...
Download [AutoFocusGraphs.0.1.0.5.zip](https://github.com/chrisflory/AutoFocusGraphs/releases/download/v0.1.0.5/AutoFocusGraphs.0.1.0.5.zip) and extract into:
